        ...
        <section className="bg-main-black py-12 md:py-24 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto container">
                <ScrollReveal variant="scale">
                    <div className="relative w-full min-h-[400px] md:min-h-[600px] rounded-[20px] md:rounded-[40px] overflow-hidden group">
                        {/* Background Image */}
                        <Image
                            src="/community.jpg"
                            alt="Community"
                            fill
                            className="object-cover object-center md:scale-[1.5] md:translate-x-[40%]"
                            priority
                        />
                        ...
                        <div className="absolute inset-0 bg-gradient-to-r from-white via-white/95 to-transparent md:via-white/100 md:to-transparent/30">
                            <div className="h-full flex flex-col justify-center px-6 sm:px-8 md:px-20 max-w-2xl space-y-12 md:space-y-16 relative z-10">
                                <div className="space-y-4 md:space-y-6">
                                    <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold font-montserrat leading-tight text-main-black">
                                ...
                                <Button
                                    className="bg-brand hover:bg-brand/90 text-white rounded-full py-4 px-8 text-base sm:py-6 sm:px-10 sm:text-xl font-bold font-montserrat self-start flex items-center gap-3 transition-transform hover:scale-105"
                                >
