...
- Create relations for cohorts → sessions
...
Migration file(s) created in backend/drizzle/ directory. Check with `ls backend/drizzle/*.sql` or similar.
  ...
  <done>
Migration files generated containing CREATE TABLE statements for admins, courses, course_sessions, research_reports, templates, cohorts, cohort_sessions tables
  </done>
</task>
...
<success_criteria>
- Database schemas for all 7 tables (admins, courses, courseSessions, researchReports, templates, cohorts, cohortSessions) exist
